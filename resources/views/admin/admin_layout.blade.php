                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user-menu">
                                <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    ...
                                    <img src="{{ asset(Auth::guard("admin")->user()->profile_picture) }}" class="user-image" alt="User Image" />
                                    @else
                                    <b>{{ Str::upper(Str::limit(Auth::guard("admin")->user()->name,2,$end="")) }}</b>
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li class="dropdown-header">
                                        @if (Auth::guard("admin")->user()->profile_picture)
                                        <img src="{{ asset(Auth::guard("admin")->user()->profile_picture) }}" class="img-circle" alt="image" />
                                        @else
                                        <b>{{ Str::upper(Str::limit(Auth::guard("admin")->user()->name,2,$end="")) }}</b>
